...
/// Types of nodes that can host app instances
...
/// Represents a physical or cloud node that can host app instances
...
pub struct Node {
    ...
    /// CPU cores currently allocated to app instances
    pub allocated_cpu: u32,
    /// Memory in MB currently allocated to app instances
    pub allocated_memory: u32,
    /// Storage in GB currently allocated to app instances
    pub allocated_storage: u32,
    /// Whether the node is online and available
    pub online: bool,
    /// The agent responsible for this node
    pub agent_id: String,
...
impl Node {
    ...
    pub fn new(id: String, name: String, node_type: NodeType, agent_id: String, 
    ...
    pub fn new_cloud(id: String, name: String, agent_id: String) -> Self {
        Self {
            id,
            name,
