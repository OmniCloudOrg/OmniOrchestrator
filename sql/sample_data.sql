...
INSERT INTO omni.users (email, name, password, salt, active, last_login_at) VALUES
...
INSERT INTO omni.roles (name, description) VALUES
('super_admin', 'Full system access'),
('org_admin',   'Organization administrator'),
('developer',   'Application developer'),
('viewer',      'Read-only access');

SET @super_admin_role_id = (SELECT id FROM omni.roles WHERE name = 'super_admin');
SET @org_admin_role_id = (SELECT id FROM omni.roles WHERE name = 'org_admin');

-- Insert Permissions with batch insert
INSERT INTO omni.permissions (name, description, resource_type) VALUES
...
-- INSERT INTO omni.instances (app_id, instance_type, status, container_id, node_name)
-- SELECT 
--     a.id,
...
INSERT INTO omni.domains (app_id, name, ssl_enabled)
SELECT 
    id,
...
-- INSERT INTO omni.builds (app_id, source_version, status, started_at, completed_at)
-- SELECT 
--     a.id,
...
INSERT INTO omni.deployments (app_id, build_id, status, started_at, completed_at)
SELECT 
    app_id,
    id,
...
INSERT INTO omni.config_vars (app_id, `key`, value, is_secret)
SELECT 
    a.id,
...
INSERT INTO omni.metrics (instance_id, metric_name, metric_value, timestamp)
SELECT 
    i.id,
    m.name,
    CASE m.name
...
INSERT INTO omni.instance_logs (instance_id, log_type, message)
SELECT 
    i.id,
...
INSERT INTO omni.api_keys (org_id, name, key_hash)
SELECT 
    id,
    'Production API Key',
...
INSERT INTO omni.audit_logs (user_id, org_id, action, resource_type, resource_id)
SELECT 
    u.id,
    o.id,
